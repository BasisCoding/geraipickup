<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Mailer {
        protected $_ci;
        protected $email_pengirim = 'Sintadwiyanti462@gmail.com'; // Isikan dengan email pengirim
        protected $nama_pengirim = 'Sinta Dwiyanti'; // Isikan dengan nama pengirim
        protected $password = 'sinsin123'; // Isikan dengan password email pengirim
        ...
        public function send($data){
            ...
            // $mail->AddEmbeddedImage('assets/img/logo.png', 'logo_basiscoding', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
